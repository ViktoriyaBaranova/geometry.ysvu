...
const checkStorage = () =>{
    if (localStorage.getItem("task-21")){
        if (localStorage.getItem("task-21")[0]) spanResult.textContent = "Результат: " + localStorage.getItem("task-21")[0] + " из 10";
        if (localStorage.getItem("task-21")[0] === "0") spanResult.textContent = "Результат: 0 из 10";  
    }else 
