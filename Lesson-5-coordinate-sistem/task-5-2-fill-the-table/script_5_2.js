...
localStorage.setItem("task-14", "0");
...
const checkStorage = () =>{    
    if (localStorage.getItem("task-14")){
        if (localStorage.getItem("task-14")[0]) spanResult.textContent = "Количество баллов: " + localStorage.getItem("task-14")[0] + " из 10";
        if (localStorage.getItem("task-14")[0] === "0") spanResult.textContent = "Количество баллов: 0 из 10";  
    }else 
