...
localStorage.setItem("task-15", "0");
...
const checkStorage = () =>{
    if (localStorage.getItem("task-15")){
        if (localStorage.getItem("task-15")[0]) spanResult.textContent = "Количество баллов: " + localStorage.getItem("task-15")[0] + " из 10";
        if (localStorage.getItem("task-15")[0] === "0") spanResult.textContent = "Количество баллов: 0 из 10";  
    }else 
