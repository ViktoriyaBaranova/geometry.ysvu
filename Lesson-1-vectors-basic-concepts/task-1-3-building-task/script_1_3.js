...
btnCheck.addEventListener("click", () => {
    ...
    if (mark != 10) {
       console.log("true");
       spanResult.textContent = "Количество баллов: " + mark + " из " + score + ". Возможные ошибки: 1) векторы отмечены неверно; 2) не все векторы отмечены";
    } else spanResult.textContent = "Количество баллов: " + mark + " из " + score;
...
const checkStorage = () =>{
    if (localStorage.getItem("task-2")){
        if (localStorage.getItem("task-2")[0]) spanResult.textContent = "Количество баллов: " + localStorage.getItem("task-2")[0] + " из 10";
        if (localStorage.getItem("task-2")[0] === "0") spanResult.textContent = "Количество баллов: 0 из 10";  
    }else 
