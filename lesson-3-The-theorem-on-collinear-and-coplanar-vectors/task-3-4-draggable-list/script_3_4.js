...
localStorage.setItem("task-11", "0");
...
const checkStorage = () =>{
    if (localStorage.getItem("task-11")){
        if (localStorage.getItem("task-11")[0]) spanResult.textContent = "Количество баллов: " + localStorage.getItem("task-11")[0] + " из 19";
        if (localStorage.getItem("task-11")[0] === "0") spanResult.textContent = "Количество баллов: 0 из 19";  
    }else 
        spanResult.textContent = "Количество баллов: - из 19";
}
...
function checkOrder() {
    ...
    const mark = count;
    spanResult.textContent = "Количество баллов: " + mark + " из " + listItems.length;
