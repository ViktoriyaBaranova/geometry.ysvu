...
const checkStorage = () =>{
    if (localStorage.getItem("task-8")){
        if (localStorage.getItem("task-8")[0]) spanResult.textContent = "Количество баллов: " + localStorage.getItem("task-8")[0] + " из 10";
        if (localStorage.getItem("task-8")[0] === "0") spanResult.textContent = "Количество баллов: 0 из 10";  
    }else 
...
btnRestart.addEventListener('click', ()=>{
    ...
    //spanResult.innerHTML = `Количество баллов: ${count}`;
