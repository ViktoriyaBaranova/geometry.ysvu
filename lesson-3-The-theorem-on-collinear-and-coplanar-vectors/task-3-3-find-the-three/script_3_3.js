...
const checkStorage = () =>{
    if (localStorage.getItem("task-10")){
        if (localStorage.getItem("task-10")[0]) spanResult.textContent = "Результат: " + localStorage.getItem("task-10")[0] + " из 10";
        if (localStorage.getItem("task-10")[0] === "0") spanResult.textContent = "Результат: 0 из 10";  
    }else 
