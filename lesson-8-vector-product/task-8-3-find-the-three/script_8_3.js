...
let mark = 0, count = 0;
localStorage.setItem("task-18", "0");
...
btnReset.addEventListener('click', ()=>{
    ...
    localStorage.removeItem("task-18");
});   
...
btnCheck.addEventListener('click', ()=>{
    ...
    mark = countRightPair.length;
    spanResult.textContent = "Количество баллов: " + mark + " из " + score;
    localStorage.setItem("task-18", [mark, checkHint]);
})

const checkStorage = () =>{
    if (localStorage.getItem("task-18")){
        if (localStorage.getItem("task-18")[0]) spanResult.textContent = "Количество баллов: " + localStorage.getItem("task-18")[0] + " из 12";
        if (localStorage.getItem("task-18")[0] === "0") spanResult.textContent = "Количество баллов: 0 из 12";  
    }else 
