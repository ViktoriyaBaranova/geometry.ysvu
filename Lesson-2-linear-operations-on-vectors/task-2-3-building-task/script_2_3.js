...
const checkStorage = () =>{
    if (localStorage.getItem("task-6")){
        if (localStorage.getItem("task-6")[0]) spanResult.textContent = "Количество баллов: " + localStorage.getItem("task-6")[0] + " из 10";
        if (localStorage.getItem("task-6")[0] === "0") spanResult.textContent = "Количество баллов: 0 из 10";  
    }else 
